...
class OptimizedInference:
    ...
    def _enable_flash_attention(self):
        ...
        try:
            ...
            elif hasattr(self.model.config, "attn_implementation") and "flash_attention" in self.model.config.attn_implementation:
                logger.info(f"Using attention implementation: {self.model.config.attn_implementation}")
            else:
